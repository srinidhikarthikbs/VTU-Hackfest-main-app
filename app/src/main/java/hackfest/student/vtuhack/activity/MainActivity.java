...
public class MainActivity extends AppCompatActivity implements FragmentDrawer.FragmentDrawerListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id)
        {
            case R.id.state:break;
            case R.id.district:break;
            case R.id.taluk:break;
            case R.id.school:break;
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            case 0:
                ...
                title = getString(R.string.title_state);
            ...
            case 1:
                ...
                break;
            case 2:
                fragment = new TalukFragment();
                title = getString(R.string.title_taluk);
                Toast.makeText(getApplicationContext(),"taluk",Toast.LENGTH_SHORT).show();
                break;
            case 3:

...
public class CreditsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView tv=(TextView) rootView.findViewById(R.id.credits);

        Thread t=new Thread(new Runnable() {
            @Override
            public void run() {
                gotresponse=0;
                String url="http://192.168.43.134/vtuhack/getstudentcredits.php?studentid="+ statictry.studentid; //fill this url later and then append the totalamount parameter
